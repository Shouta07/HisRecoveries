...
export default function SampleResult() {
  ...
  return (
    <section className="mx-auto max-w-[1080px] px-5 pt-12 sm:px-8 sm:pt-[88px] lg:px-12 lg:pt-[120px]">
      ...
      {/* もとは「答えが変われば、順番も、今月やることも変わります」と書いていた。
          全2,400通りで実際に出力を数えたら、83%が同じ1番目（清潔感・第一印象）だった。
          つまりこの一文は、8割の人にとって嘘になる。

          ただし、同じ答えが返ること自体は不具合ではない。
          「気になっている場所と、手をつける場所は、たいてい違う」
          というのがこのサイトの主張そのもので、
          その結果として多くの人が同じ入口になる。
          隠すのではなく、そう言い切るほうが正しい。 */}
      <p className="mt-5 max-w-[34em] text-[13px] leading-[1.95] text-ainezu">
        いちばん気になっている場所と、先に手をつける場所は、たいてい違います。
        だから多くの人が、ここと同じ「清潔感・第一印象」から始まります。
        <span className="mt-1 block">
          変わるのは、そのあとの並びと、今月やること3つの中身です。
