// Stage 1 — 現在地を知る。
// 二つの向き(Recover / Refine)を「商品」ではなく「問い」として提示し、
// その直下に、外側の現在地(印象診断)と内側の現在地(血液・準備中)を置く。
// 価格は外側のみ(¥22,000)。血液は準備中で価格非公開。
...
export default function TenToSenSection() {
  return (
    <section id="genchi" className="relative z-10 scroll-mt-24 text-[#1f2a1d]">
      <div className="max-w-[1100px] mx-auto px-5 sm:px-8 pt-10 sm:pt-16 pb-6">
        <div className="on-media max-w-2xl mb-8">
          ...
          <h2 className="text-[1.5rem] sm:text-[1.9rem] md:text-[2.3rem] leading-[1.4]" style={{ ...MINCHO, fontWeight: 800 }}>
            まず、いまの自分を知ることから。
          </h2>
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          >
            ...
            <span className="mt-4 inline-flex items-center gap-1.5 text-[12px] font-semibold text-[#3d5638] group-hover:gap-2.5 transition-all">
