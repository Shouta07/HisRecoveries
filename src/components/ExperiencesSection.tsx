// できること（体験）— はじめかた5ステップの「③現在地〜④体験」の具体。
// experiences レジストリから描画（拡張は配列に1件足すだけ）。
      ...
      <div className="max-w-[1100px] mx-auto px-5 sm:px-8 pt-8 sm:pt-14 pb-6">
        <div className="on-media max-w-2xl mb-6">
          <div className="flex items-center gap-2.5 mb-2">
            ...
            <span className="font-mono text-[11px] tracking-[0.22em] uppercase text-[#3d5638] font-medium">できること — いま動きたい人にも、そろそろの人にも</span>
          </div>
