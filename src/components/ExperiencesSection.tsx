...
const PLANS: Plan[] = [
  {
    ...
    from: "¥49,800（税込）",
    entry: "30日。眉・メイク・服・髪・撮影の体験を含みます（服・化粧品の実費は別）",
    href: "/recover",
    cta: "Recover を詳しく見る",
    line: false,
  },
      ...
      <div className="max-w-[1100px] mx-auto px-5 sm:px-8 pt-8 sm:pt-14 pb-6">
        <div className="on-media max-w-2xl mb-6">
          ...
          <div className="mt-5 inline-flex flex-wrap items-center gap-x-3 gap-y-1.5 rounded-[1rem] bg-white border border-[#1f2a1d]/12 px-4 py-3">
            ...
            <span className="text-[15px] font-bold text-[#16241A]" style={MINCHO}>¥49,800（30日・先着10名）</span>
            <span className="text-[11.5px] text-[#6b7a66]">税込・会場費込み。11名以降は ¥66,000</span>
          </div>
        </div>
