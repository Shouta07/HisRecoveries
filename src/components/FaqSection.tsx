...
const FAQ = [
  ...
  { q: "人に知られたくありません。秘密は守られますか？", a: "はい。ご相談を始める前に、相互の秘密保持契約（NDA）にご同意いただきます。話した内容も、あなたのことも、外に出しません。実名は不要で、LINE の表示名（ニックネーム可）で進められます。顔写真も要りません。" },
  { q: "途中から実名が必要になりますか？", a: "段階を分けています。無料相談と印象診断は、実名なし（LINE の表示名）で構いません。体験にお申し込みいただき、記録をあなたのものとしてお預かりする段階では、ご本人の同意のうえでお名前を確認させていただきます。同意されない場合、記録はお預かりしません。" },
  { q: "料金はどう決まりますか？", a: "あなたに合わせて組むオーダーメイドのため、費用は内容によります。最初の相談は無料です。印象診断セッション（¥22,000・パッケージお申し込みで全額充当）で内容を伺い、総額の目安と内訳を、契約の前に必ずお伝えします。あとから増える見積りで驚かせることはしません。ご納得のうえで、お申し込みいただけます。" },
  ...
  { q: "いま申し込むと、どうなりますか？", a: "現在は無料相談を受付中です。LINE で友だち追加し、秘密保持契約にご同意いただければ、そのまま相談を始められます。体験のご案内は、相談の内容に合わせて準備が整い次第お送りします。" },
