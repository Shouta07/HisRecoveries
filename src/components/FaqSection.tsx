...
const FAQ = [
  ...
  { q: "人に知られたくありません。匿名でできますか？", a: "はい。すべて完全匿名・完全守秘義務のもとで運営します。実名・顔写真は不要で、ニックネームと連絡用の連絡先だけで大丈夫です。" },
  { q: "料金はどう決まりますか？", a: "最初の相談は無料・完全匿名です。その後、印象診断セッション（¥22,000・パッケージお申し込みで全額充当）で内容を伺い、最終価格をご提示します。ご納得のうえでお申し込みいただけます。" },
