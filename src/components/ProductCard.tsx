...
const btn =
  "inline-flex items-center gap-1.5 text-xs tracking-[0.06em] text-ink border border-ink/30 hover:border-gold hover:bg-gold hover:text-cream px-3 py-2 transition-colors";
