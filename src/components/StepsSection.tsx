...
const STEPS = [
  ...
  { n: "03", t: "現在地を知る", d: "外側は印象診断（¥22,000）、内側は血液（準備中）で。悪いところ探しではなく、いまの自分を。" },
  { n: "04", t: "プランを、一緒に", d: "費用は先に説明します。合意した予算を超える提案はしません。売り込みなし。" },
  { n: "05", t: "体験して、記録が残る", d: "プロチームと一歩ずつ。相談も変化も、LINEで続く。記録はあなたのもの——いつでも見返せ、消せます。" },
];
