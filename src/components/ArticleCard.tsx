...
export default function ArticleCard({
    ...
    return (
      ...
      >
        ...
        <div className="mt-5">
          ...
          <h3 className="mt-3 font-mincho text-xl leading-[1.55] text-ink group-hover:text-quiet-brass transition-colors">
            {article.title}
          </h3>
          ...
          <span className="mt-4 inline-flex items-center gap-2 text-sm text-ink border-b border-hair-line group-hover:border-ink transition-colors pb-0.5">
            読む
  ...
  // List variant — Aesop-style editorial line
  return (
    <article className="border-b border-hair-line py-10 last:border-b-0">
      ...
      >
        <div className="sm:order-1">
          <div className="text-[10px] tracking-[0.3em] uppercase text-sub-gray">
          ...
          <h2 className="mt-3 font-mincho text-xl sm:text-2xl leading-[1.55] text-ink group-hover:text-quiet-brass transition-colors">
            {article.title}
          </h2>
          {showExcerpt && article.excerpt && (
