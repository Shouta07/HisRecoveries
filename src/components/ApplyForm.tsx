...
export default function ApplyForm() {
  ...
  const field =
    "w-full rounded-2xl border border-[#1B2024]/15 bg-white px-4 py-3 text-[16px] text-[#1B2024] outline-none focus:border-[#2F6F79] transition-colors";
  ...
  if (status === "success") {
    return (
      <div className="rounded-[1.6rem] border border-[#1B2024]/12 bg-[#F1F3F3] p-8 sm:p-10 text-center">
        ...
        <p className="mt-5 text-[13.5px] text-[#5E6E76]">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          required
        />
        <p className="mt-1.5 text-[12.5px] text-[#5E6E76] leading-[1.7]">
      ...
      {/* 秘密保持 — 必須同意 */}
      <div className="rounded-2xl border border-[#1B2024]/15 bg-[#F1F3F3] p-5">
        <p className="text-[14.5px] font-bold text-[#1B2024] mb-2">
          秘密保持について（必須）
        </p>
        ...
        <label className="mt-4 flex items-start gap-3 cursor-pointer">
          <input
            ...
            className="mt-0.5 w-5 h-5 accent-[#2F6F79] shrink-0"
            required
          />
          <span className="text-[15px] font-normal text-[#1B2024] leading-[1.7]">
      ...
      <p className="text-[12.5px] text-[#5E6E76] leading-[1.8]">
