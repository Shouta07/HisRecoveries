export const site = {
  ...
  description:
    "男性の第一印象を、30日で整える。何をやるかを決めて、眉・メイク・服選び・髪型・撮影を1日でまとめて整え、メイクの手順動画・服のサイズ表・髪型のオーダー資料をお渡しします。第一印象改善プラン（30日）¥49,800 税込・先着10名。実施は東京都内・土日のみ。相談は無料・完全守秘で、医療機関から紹介料は受け取りません。",
  url:
