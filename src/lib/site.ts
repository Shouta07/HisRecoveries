export const site = {
  ...
  description:
    "髪・肌・睡眠・疲れ・体・パートナーとのこと。男性の美容・健康・恋愛を扱う編集メディアです。薄毛・AGA、ニキビ、第一印象、髭・体毛、顔の印象、心と習慣について、出典を明記して整理し、編集部が実際に確かめたことを書いています。提携先から紹介料を受け取っていないため「いまはやらなくていい」と書けます。効果の保証はしません。",
  url:
