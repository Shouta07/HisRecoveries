export const site = {
  ...
  promise: "理想の男に、最短距離で。",
  description:
    "理想の男に、最短距離で。恋愛、仕事、人生の節目——あなたが叶えたい理想から逆算し、必要な変化の順番を設計する男性ウェルネスコンシェルジュ。髪・肌・体・心をまとめて診断し、合うプロ・施設へおつなぎして、そのあとも伴走します。相談は無料・完全守秘、費用は先に説明。押し売りはせず、医療機関から紹介料は受け取りません。",
  url:
