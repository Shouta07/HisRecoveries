...
export const entryDiagnosis = {
  ...
  price: "¥22,000",
  duration: "90分・オンライン可",
  note: "90分で、第一印象を要素に分解。「整える順番」を持ち帰れます。パッケージ申込で全額充当。",
};
...
export const bloodCheck = {
  name: "血液コンディション・チェック",
  status: "準備中",
  note: "悪いところを探す検査ではなく、現在地を知る検査。ご案内は、匿名の無料相談から。",
};
