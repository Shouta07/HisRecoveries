...
export const complexes: Complex[] = [
  ...
  },
  {
    ...
    why: "汗にはエクリン腺（水っぽい汗）とアポクリン腺（脇などのタンパク・脂質を含む汗）があり、後者が皮膚常在菌に分解される過程で、特有のにおいが生まれます。つまり「におい」は汗そのものより、菌の代謝の結果。汗の量・湿度・常在菌のバランスで強さが変わるため、対処は「量」と「菌」を分けて考えるのが基本です。",
    accent: "#0F766E",
    accentSoft: "#E5F4F2",
  },
  {
  ...
  },
  {
    ...
    worry: "鏡を見るのが、ちょっと怖い",
    stat: "気にしすぎ、には理由がある",
    why: "自分の欠点ばかりに注意が向く「注意のバイアス」と、自己評価の癖が、悩みを実際以上に大きく感じさせます。鏡や写真で何度も確認する行動は、不安を一時的に下げる一方で、長期的には自意識を強める。だから「気にしすぎ」は性格ではなく、注意と評価の仕組みの問題として扱えます。",
    accent: "#4338CA",
    accentSoft: "#EAEAFB",
  },
];
