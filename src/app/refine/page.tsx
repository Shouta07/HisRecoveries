...
const INCLUDES = [
  { t: "カウンセリング（無料）", d: "「整っている」の先を言語化。伸ばす一点と、先手を打つ一点を地図に。合わなければ、その場でお伝えします。" },
        ...
        <section className="pt-12 sm:pt-14">
          <div className="rounded-[1.4rem] bg-white border border-[#1f2a1d]/10 p-6 sm:p-8">
            ...
            <p className="mt-2 text-[12.5px] text-[#4b5b47] leading-[1.9]">
              第一印象改善プラン1本です。無料のカウンセリングで状況を伺い、合うかどうかをお伝えします。会場費は含みます。服・化粧品・カット代・交通費は実費としてご負担ください。お支払い後のキャンセルはお受けしていません。
            </p>
