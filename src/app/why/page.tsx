  ...
  return (
    <div className="bg-[#F3F0EA] text-[#1F1E1B]">
      ...
      <section className="relative overflow-hidden bg-[#2C3A2E] text-[#F3F0EA]">
        <div aria-hidden className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 95% 75% at 50% 18%, #3A4B3C 0%, #2C3A2E 58%, #1E2A20 100%)" }} />
        <div className="relative max-w-[760px] mx-auto px-5 sm:px-8 pt-14 sm:pt-20 pb-12 sm:pb-16">
          ...
          <h1 className="text-[#F3F0EA] text-[2rem] sm:text-[2.9rem] leading-[1.35] font-[800]" style={HEAD}>
            治らない時間を、<br />
            <span className="text-[#B9A06B]">知っているから。</span>
          </h1>
        </div>
      </section>
      ...
      <div className="max-w-[680px] mx-auto px-5 sm:px-8 py-12 sm:py-16">
        <div className="space-y-7 text-[15px] sm:text-[16px] leading-[2.05] text-[#45443E]">
          ...
          <p>
            ...
            それでも、すぐには治らなかった。
            <span className="font-semibold text-[#2C3A2E]">何年も、かかりました。</span>
          </p>
          <p>
          ...
          <p className="text-[1.15rem] sm:text-[1.3rem] font-[800] text-[#2C3A2E] leading-[1.7] py-2" style={HEAD}>
            いちばん困ったのは、<br />
          ...
          <p>
            ...
            <span className="font-semibold text-[#2C3A2E]">その判断が、ずっと終わらない。</span>
            そして、聞ける相手がいない。友達には言えない。家族には、もっと言えない。
            検索すれば、出てくるのは売り込みばかりでした。
          </p>

          <p>
            だから His Recoveries は、<span className="font-semibold text-[#2C3A2E]">結果を約束しません</span>。
          ...
          <p className="text-[1.15rem] sm:text-[1.3rem] font-[800] text-[#2C3A2E] leading-[1.7] py-2" style={HEAD}>
            約束するのは、<br />
            <span className="text-[#8A6A3B]">判断を、一人で抱えなくていい状態</span>です。
          </p>
          ...
          <p>
            ...
            肌はそのうちの一つだからです。
            <span className="font-semibold text-[#2C3A2E]">十割ではありません。</span>
        ...
        {/* CTA */}
        <div className="mt-8 rounded-[1.6rem] bg-[#2C3A2E] text-[#F3F0EA] p-7 sm:p-9">
          <h2 className="text-[1.25rem] sm:text-[1.55rem] leading-[1.5] mb-2 text-[#F3F0EA] font-[800]" style={HEAD}>
            まず、あなたの<span className="text-[#B9A06B]">「整える順番」</span>を。
          </h2>
          <p className="text-[14.5px] text-[#CBCEC4] leading-[1.95] mb-6">
            30秒・無料・匿名。迎えたい日を選ぶだけで、その日までにやることの順番をお見せします。
            相談は、そのあとで大丈夫です。
          </p>
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/#plan" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#F3F0EA] hover:bg-white text-[#2C3A2E] text-[15px] font-bold px-7 py-3.5 transition-colors">
