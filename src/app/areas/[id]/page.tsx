    ...
    <div className="bg-[#f4f6f2] text-[#1f2a1d]">
      ...
      <div className="mx-auto max-w-[760px] px-6 sm:px-10 pt-16 sm:pt-24 pb-24">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <ConsultLink market={c.id} className="inline-flex items-center gap-2 rounded-full border border-[#1f2a1d]/20 hover:border-[#1f2a1d] text-[#1f2a1d] text-sm font-semibold px-7 py-3.5 transition-colors">
