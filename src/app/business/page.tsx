    ...
    <div className="bg-[#F3F0EA] text-[#1F1E1B]">
      ...
      <section className="relative overflow-hidden bg-[#1E2A38] text-[#F3F0EA]">
        ...
        <div className="relative max-w-[900px] mx-auto px-5 sm:px-8 pt-14 sm:pt-20 pb-12 sm:pb-16">
          <nav aria-label="パンくず" className="text-[12.5px] text-[#8E979E] mb-8">
            ...
            <span className="text-[#F3F0EA]">法人の方へ</span>
          </nav>

          <p className="hr-eyebrow hr-eyebrow-on-dark mb-4">法人・団体の方へ</p>
          <h1
            className="text-[1.8rem] sm:text-[2.5rem] leading-[1.4] text-[#F3F0EA]"
            style={HEAD}
          >
            <span className="inline-block">「清潔感を出しましょう」で</span>
            <br />
            <span className="inline-block">終わらせない、</span>
            <span className="inline-block text-[#C28863]">男性向けの研修。</span>
          </h1>
      ...
      <div className="max-w-[900px] mx-auto px-5 sm:px-8">
        ...
        <section className="py-12 sm:py-16 hr-readable">
          <div className="rounded-[1.3rem] border-l-[3px] border-l-[#97613F] border-y border-r border-[#1F1E1B]/10 bg-white px-6 sm:px-8 py-6">
            <p className="text-[12.5px] font-bold tracking-[0.08em] text-[#97613F] mb-2">
              先に、正直なところ
            </p>
            <p className="text-[16px] sm:text-[17px] font-bold text-[#1F1E1B] leading-[1.65] mb-3" style={HEAD}>
              法人での実施実績は、まだありません。
            </p>
        ...
        <section className="pb-12 sm:pb-16 hr-readable">
          <p className="hr-eyebrow mb-3.5">想定している組織</p>
          ...
          <p className="mt-4 text-[14.5px] text-[#45443E] leading-[1.95] max-w-[36rem]">
            ...
            <strong className="text-[#1F1E1B]">外部が言えば、単なる情報になります。</strong>
          </p>
          ...
          <ul className="mt-8 grid sm:grid-cols-2 gap-3.5">
            {AUDIENCES.map((a) => (
              <li
                key={a.id}
                className="rounded-[1.2rem] bg-white border border-[#1F1E1B]/10 px-6 py-6"
              >
                <p className="text-[15.5px] font-bold text-[#1F1E1B] leading-[1.55]" style={HEAD}>
                  {a.who}
                </p>
                <p className="mt-2.5 text-[13.5px] text-[#45443E] leading-[1.95]">{a.pain}</p>
                <p className="mt-3 pt-3 border-t border-[#1F1E1B]/10 text-[13px] text-[#97613F] font-semibold">
                  {a.form}
                </p>
              </li>
            ))}
        ...
        <section id="program" className="pb-12 sm:pb-16 scroll-mt-24 hr-readable">
          <p className="hr-eyebrow mb-3.5">研修の中身</p>
          <h2 className="text-[1.4rem] sm:text-[1.9rem] leading-[1.45]" style={HEAD}>
            座学で終わらせず、
            <br className="sm:hidden" />
          ...
          <ol className="mt-8 relative border-l-2 border-[#97613F]/30 ml-3.5 space-y-7">
            {PROGRAM.map((p) => (
              <li key={p.n} className="relative pl-7">
                ...
                <p className="mt-1 text-[14px] text-[#45443E] leading-[1.95]">{p.d}</p>
              </li>
            ))}
          </ol>

          <div className="mt-8 rounded-[1.2rem] bg-[#EDE9E0] px-6 py-6">
            <p className="text-[12.5px] font-bold tracking-[0.08em] text-[#97613F] mb-2">
              研修後に残るもの
            </p>
            <p className="text-[14px] text-[#45443E] leading-[1.95]">
              受講者ごとの<strong className="text-[#1F1E1B]">印象カルテ</strong>（どこが効くか・何をやらないか）、
              <strong className="text-[#1F1E1B]">服のサイズ表</strong>（肩幅・着丈・袖丈）、
              <strong className="text-[#1F1E1B]">髪型のオーダー資料</strong>。
        ...
        {/* ── 中立性の宣言（法人でも同じ基準） ── */}
        <section className="pb-12 sm:pb-16 hr-readable">
          <p className="hr-eyebrow mb-3.5">法人でも変えないこと</p>
          <h2 className="text-[1.4rem] sm:text-[1.9rem] leading-[1.45]" style={HEAD}>
            受講者に、何も売りません。
          </h2>
          <p className="mt-4 text-[14.5px] text-[#45443E] leading-[1.95] max-w-[36rem]">
          ...
          <div className="mt-8 grid sm:grid-cols-2 gap-3.5">
            {PRINCIPLES.map((p) => (
              <div
                ...
                className="rounded-[1.2rem] bg-white border border-[#1F1E1B]/10 px-6 py-6"
              >
                <p className="flex items-baseline gap-2.5 text-[15px] font-bold text-[#1F1E1B] leading-[1.55]">
                  <span aria-hidden className="w-2 h-2 shrink-0 rounded-full bg-[#97613F]" />
                  {p.t}
                </p>
                <p className="mt-2 text-[13.5px] text-[#45443E] leading-[1.95]">{p.d}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* ── 見積 ── */}
        <section className="pb-12 sm:pb-16 hr-readable">
          <p className="hr-eyebrow mb-3.5">お見積り</p>
          <h2 className="text-[1.4rem] sm:text-[1.9rem] leading-[1.45]" style={HEAD}>
            金額は、個別にお出しします。
          </h2>
          <p className="mt-4 text-[14.5px] text-[#45443E] leading-[1.95] max-w-[36rem]">
          ...
          <ul className="mt-6 grid sm:grid-cols-2 gap-x-8 gap-y-2.5 max-w-[40rem]">
            {QUOTE_FACTORS.map((f, i) => (
              <li key={f} className="flex gap-3 text-[14px] text-[#45443E] leading-[1.9]">
                <span
                  aria-hidden
                  className="hr-figure shrink-0 text-[12.5px] font-bold text-[#97613F] pt-1"
                >
          ...
          <p className="mt-6 text-[13.5px] text-[#5E6A70] leading-[1.9]">
      ...
      <section className="bg-[#1E2A38] text-[#F3F0EA]">
        <div className="max-w-[900px] mx-auto px-5 sm:px-8 py-14 sm:py-20">
          <p className="hr-eyebrow hr-eyebrow-on-dark mb-4">お問い合わせ</p>
          <h2
            className="text-[1.4rem] sm:text-[1.9rem] leading-[1.55] text-[#F3F0EA]"
            style={HEAD}
          >
            <span className="inline-block">まず、御社の課題を</span>
            <span className="inline-block">聞かせてください。</span>
          </h2>
          <p className="mt-5 text-[14.5px] text-[#C6CAD0] leading-[2] max-w-[34rem]">
          ...
          <p className="mt-6 text-[12.5px] text-[#8E979E] leading-[1.9]">
