    ...
    <div className="bg-[#f4f6f2] text-[#1f2a1d] min-h-screen">
      ...
      <section className="relative overflow-hidden bg-[#16241A] text-[#EDF1E8]">
        ...
        <div className="relative max-w-[820px] mx-auto px-5 sm:px-8 pt-14 sm:pt-20 pb-12 sm:pb-14">
          ...
          <div className="hr-eyebrow hr-eyebrow-on-dark mb-4">FREE CONSULT — 無料</div>
          ...
          <p className="mt-5 text-[15px] sm:text-[15px] text-[#C9D2C4] leading-[2] max-w-[38rem]">
          ...
          <div className="mt-7 flex flex-wrap gap-2">
            {CHIPS.map((c) => (
              <span key={c} className="rounded-full border border-[#85AB8B]/30 bg-white/[0.06] px-3.5 py-1.5 text-[13.5px] font-medium text-[#D7DED2]">
                {c}
              </span>
            ))}
          </div>
      ...
      <div className="max-w-[820px] mx-auto px-5 sm:px-8 pt-10 sm:pt-12 pb-16">
        <div className="rounded-[1.4rem] border border-[#1f2a1d]/10 bg-white/70 p-5 sm:p-6 mb-8">
          <p className="text-[15px] font-bold text-[#1f2a1d] mb-1.5" style={MINCHO}>
            お取り扱いは、30日プラン1本だけです。
          </p>
        ...
        <div className="mt-10 rounded-[1.3rem] bg-[#16241a] text-[#EDF1E8] p-6 sm:p-7">
          <div className="hr-eyebrow hr-eyebrow-on-dark mb-4">After the consult — このあとの流れ</div>
          <ol className="space-y-2.5 text-[14.5px] text-[#C9D2C4] leading-[1.8]">
            {AFTER.map((t, i) => (
              <li key={t}>
