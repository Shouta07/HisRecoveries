...
export const metadata: Metadata = {
  ...
  description:
    "His Recoveries のプライバシーポリシーおよび免責事項です。ご相談は匿名（カメラオフ・表示名なし・非録画）・完全守秘のもとで。記録・実名に進む段階で相互の秘密保持契約（NDA）を結びます。医療行為は行いません。診断・治療は連携する医療機関が行います。",
      ...
      <div className="mx-auto max-w-[760px] px-6 sm:px-10 pt-16 sm:pt-24 pb-24">
        ...
        <section className="mb-12 rounded-[1.4rem] border border-[#1f2a1d]/10 bg-[#16241a] text-[#EDF1E8] p-6 sm:p-8">
          ...
          <div className="text-[14px] leading-[2] text-[#C9D2C4] space-y-4">
            <p>
              His Recoveries（以下「本プログラム」）は、<strong className="font-bold text-[#EDF1E8]">匿名（カメラオフ・表示名なし・非録画）でのご相談から始められる</strong>、
              完全守秘のもとで運営するコンプレックス改善プログラムです。記録の預かり・実名の確認は、体験に進む段階で、ご本人の同意のうえ相互の秘密保持契約（NDA）を結んでから行います。
        ...
        <div className="space-y-10">
          <Section n="01" title="基本方針">
            <p>
              ...
              プライバシーを尊重し、その保護に努めます。本プログラムは<strong className="font-bold text-[#1f2a1d]">匿名のまま相談から始められる設計</strong>とし、完全守秘義務のもとで運営します。
              実名・記録の預かりに進む段階でのみ、ご本人の同意のうえ相互の秘密保持契約（NDA）を結び、必要最小限の情報を確認します。
              ご本人を不必要に特定する情報を保持しないことを基本方針とします。
            </p>
          </Section>

          <Section n="02" title="取得する情報">
            <p>当社は、本プログラムの提供にあたり、次の情報を取得することがあります。</p>
            <ul className="list-disc pl-5 space-y-2 marker:text-[#85AB8B]">
              <li>相談のご予約・お申し込みの際にご提供いただく連絡先およびご相談内容。日程調整は外部の予約ツールを利用します（当該ツールの取扱いは各社のポリシーに従います）。</li>
              <li>無料のWeb相談で伺った内容。<strong className="font-bold text-[#1f2a1d]">相談はカメラオフ・表示名なしで参加でき、録画は行いません。</strong></li>
              <li>体験に進む段階で、ご本人の同意のもとで確認する実名・連絡先、および作成・記録する会員ID単位の状態・記録等の情報。</li>
