...
// デモ（擬似ログイン）で動作する。
// 血液検査データ等＝要配慮個人情報のため、本番は His Recoveries for Business 側で安全に扱う
// （docs/HRB_PLATFORM_SPEC.md / MEMBER_PLATFORM_SPEC.md）。
// 検索インデックスには載せない（noindex）。
export const metadata: Metadata = {
  title: "会員ページ（β） | His Recoveries",
  description:
    "LINE ログインで使う会員ページ。あなたの物語（相談・来訪・記録）が His Recoveries for Business から映し出されます。※現在はプロトタイプ（デモ）です。",
